...
final class ExperiencesDatasetReaderTest extends TestCase
{
    ...
    public function testItFiltersOnThePeriodAndOnTheLengthOfTheText(): void
    {
        ...
        self::assertSame(['first-day', 'last-day'], array_map(static fn (Experience $e): string => $e->id, iterator_to_array($experiences)));
    }
     ...
     */
    private function writeDataset(array $rows): void
    {
